...
INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Luis', 'Hern�ndez', 'San Jos�, Calle 5', '83778894', 'luis.hernandez@gmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Laura', 'D�az', 'Puntarenas, Avenida del Mar', '65412578', 'laura.diaz@hotmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Javier', 'L�pez', 'Alajuela, Avenida Central', '83763345', 'javier.lopez@yahoo.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Isabel', 'Torres', 'Heredia, Calle 10', '65478901', 'isabel.torres@gmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Ricardo', 'Fern�ndez', 'San Jos�, Avenida 2', '83761234', 'ricardo.fernandez@hotmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Sof�a', 'Chaves', 'Puntarenas, Calle Principal', '65423456', 'sofia.chaves@yahoo.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Diego', 'Mora', 'Alajuela, Avenida Norte', '83762233', 'diego.mora@gmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Valentina', 'Arias', 'Heredia, Calle 3', '65487654', 'valentina.arias@hotmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Felipe', 'Soto', 'San Jos�, Avenida 8', '83764567', 'felipe.soto@yahoo.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Elena', 'Uma�a', 'Puntarenas, Calle 15', '65434567', 'elena.umana@gmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Miguel', 'Alvarado', 'Alajuela, Avenida 12', '83766678', 'miguel.alvarado@hotmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Valeria', 'Jim�nez', 'Heredia, Avenida Sur', '65456789', 'valeria.jimenez@yahoo.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Andr�s', 'Cruz', 'San Jos�, Calle 20', '83767789', 'andres.cruz@gmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Camila', 'Chac�n', 'Puntarenas, Avenida Oeste', '65445678', 'camila.chacon@hotmail.com');

INSERT INTO CLIENTE (NOMBRE, APELLIDO, DIRECCION, TELEFONO, CORREO) 
VALUES ('Mateo', 'Rojas', 'Alajuela, Calle 18', '83768890', 'mateo.rojas@yahoo.com');


-- Inserciones en la tabla DISTRIBUIDOR
INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Costa Rica Norte', 'Avenida Norte, San Jos�', '83761234');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Tico Express', 'Calle 4, Heredia', '65415678');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Pura Vida', 'Avenida Central, Alajuela', '88889876');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Pacifico', 'Calle 7, Puntarenas', '83772345');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Monteverde', 'Calle 12, Guanacaste', '77775678');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Caribe', 'Avenida Lim�n, Lim�n', '65438765');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Cartago', 'Calle 2, Cartago', '83767890');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Herediano', 'Avenida San Rafael, Heredia', '55553456');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Tamarindo', 'Calle 6, Guanacaste', '65435678');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Jac�', 'Avenida Jac�, Puntarenas', '77779876');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Alajuelense', 'Calle 5, Alajuela', '83768765');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Limonense', 'Avenida 8, Lim�n', '55552345');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor San Jos� Sur', 'Calle 3, San Jos�', '65437890');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Cartagin�s', 'Avenida Cartago, Cartago', '83765678');

INSERT INTO DISTRIBUIDOR (NOMBRE, DIRECCION, TELEFONO) 
VALUES ('Distribuidor Heredia Central', 'Calle 10, Heredia', '77773456');


-- Inserciones en la tabla EMPLEADO
INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Ana', 'Ram�rez', '83778894', 'ana.ramirez@gmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Carlos', 'L�pez', '65412578', 'carlos.lopez@hotmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Mar�a', 'Gonz�lez', '84521657', 'maria.gonzalez@yahoo.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Jorge', 'Fern�ndez', '65878954', 'jorge.fernandez@gmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Isabel', 'Torres', '87988852', 'isabel.torres@hotmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Andr�s', 'Soto', '62156489', 'andres.soto@yahoo.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Laura', 'Jim�nez', '67841352', 'laura.jimenez@gmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Jos�', 'Hern�ndez', '65124578', 'jose.hernandez@hotmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Valentina', 'Arias', '88874515', 'valentina.arias@yahoo.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Felipe', 'Mora', '88996512', 'felipe.mora@gmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Luis', 'Vargas', '68965478', 'luis.vargas@hotmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Sof�a', 'Chaves', '45245487', 'sofia.chaves@yahoo.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Diego', 'Alvarado', '63245678', 'diego.alvarado@gmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Valeria', 'L�pez', '89653256', 'valeria.lopez@hotmail.com');

INSERT INTO EMPLEADO (NOMBRE, APELLIDO, TELEFONO, CORREO) 
VALUES ('Miguel', 'G�mez', '61478452', 'miguel.gomez@yahoo.com');
...
INSERT INTO COLOR (COLOR) VALUES ('Marr�n');
INSERT INTO COLOR (COLOR) VALUES ('Beige');


-- Inserciones en la tabla MARCA
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Hyundai');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Mitsubishi');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Kia');
...
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Jeep');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Suzuki');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Mercedes-Benz');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Audi');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('BMW');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Lexus');
INSERT INTO MARCA (NOMBRE_MARCA) VALUES ('Acura');
...
INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Corolla', 14, 2023, 25900, '1HGCM82633A400001', 1);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Civic', 15, 2023, 24900, '2HGCM82673A400002', 2);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('F-150', 13, 2023, 37900, '1FTNF21524ED62412', 3);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Silverado', 12, 2023, 36900, '1GCEC14X95E287489', 4);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Altima', 14, 2023, 26900, '1N4AA5AP7DN805515', 5);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Elantra', 16, 2023, 21900, '5NPD84LF4LH656789', 6);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Outlander', 17, 2023, 26900, 'JA4AR3AU9NZ000786', 7);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Sorento', 16, 2023, 26900, '5XYPGDA53KG371234', 8);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Tiguan', 13, 2023, 28900, 'WVGSV7AX6KW000001', 9);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Impreza', 18, 2023, 21900, 'JF1GJAC6XHH634567', 10);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('CX-5', 19, 2023, 25900, 'JM3KFADL7L0912345', 11);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Wrangler', 20, 2023, 33900, '1C4HJWEG6HL600001', 12);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Vitara', 21, 2023, 21900, 'JS2YA11N4K6100001', 13);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('E-Class', 22, 2023, 53900, 'WDDZF4KBXJA123456', 14);

INSERT INTO AUTOMOVIL (MODELO, ID_MARCA, A�O, PRECIO, NUMERO_VIN, ID_COLOR) 
VALUES ('Q5', 23, 2023, 45900, 'WA1AAAFY6J2234567', 15);
...
INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-06', 'YYYY-MM-DD'), 6, 6, 6);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-07', 'YYYY-MM-DD'), 7, 7, 7);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-08', 'YYYY-MM-DD'), 8, 8, 8);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-09', 'YYYY-MM-DD'), 9, 9, 9);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-10', 'YYYY-MM-DD'), 10, 10, 10);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-11', 'YYYY-MM-DD'), 11, 11, 11);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-12', 'YYYY-MM-DD'), 12, 12, 12);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-13', 'YYYY-MM-DD'), 13, 13, 13);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-14', 'YYYY-MM-DD'), 14, 14, 14);

INSERT INTO VENTA (FECHA_VENTA, ID_CLIENTE, ID_AUTOMOVIL, ID_EMPLEADO) 
VALUES (TO_DATE('2023-11-15', 'YYYY-MM-DD'), 15, 15, 15);
